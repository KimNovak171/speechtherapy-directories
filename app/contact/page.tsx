...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with AutoRepairDirectories.com. Send a message or email support@autorepairdirectories.com for questions about our directory or featured listings.",
  alternates: {
    canonical: "/contact",
    languages: {
